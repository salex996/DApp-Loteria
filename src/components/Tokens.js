...
class Tokens extends Component {
  ...
  _balanceEthersSC = async () => {
    try {
      console.log("Balance de Ethers en ejecucion...")
  ...
  _compraTokens = async (_numTokens) => {
    try{
      console.log("compra tokens en ejecución...")
      const web3 = window.web3
      ...
      Swal.fire({
        icon: 'success',
        title: 'Compra Tokens realizada!',
        width: 800,
        padding: '3em',
        text: `Has comprado ${_numTokens} tokens por un valor de ${ethers / 10**18} ethers`,
        backdrop: `
          rgba(15, 238, 168, 0.2)
          left top
          no-repeat
...
_devolverTokens = async(_numTokens)=>{
 try {
  ...
  Swal.fire({
    ...
    width: 800,
    padding: '3em',
    text: `Has devuelto ${_numTokens} tokens `,
    backdrop: `
      rgba(15, 238, 168, 0.2)
      left top
      no-repeat
                ...
                <Container>
                  <Row>
                    ...
                    <form onSubmit={(event) => 
                        ...
                        value="BALANCE DE TOKENS DEL SMART CONTRACT">
                        </input>
                      </form>
                    </Col>
                    <Col>
